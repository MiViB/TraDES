...
SeqIdPtr LIBCALL MakeRANDId PROTO((BiostrucSourcePtr bssp, MoleculeGraphPtr mgp, DbtagPtr dtp));
...
SeqEntryPtr LIBCALL MakeBioseqs PROTO((BiostrucPtr bsp, BiostrucResidueGraphSetPtr stdDictionary));
